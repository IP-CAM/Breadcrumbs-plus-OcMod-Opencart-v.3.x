The Breadcrumbs+ extension is for CMS Opencart 3.x. It allows to getting the full path of product categories in breadcrumb navigation. Also, the extension allows to add JSON-LD structured data markup for breadcrumb trails to categorize the information from the page in search results, allows to remove links from the last breadcrumb items and set bold font for them.
...
[b]Change log[/b]
* v1.1 (2019.10.30):
-- Added compatibility with the [url=]SDI+[/url] extension
...
[b]Links[/b]
* [url=https://github.com/underr-ua/ocmod3-breadcrumbs-plus]GitHub[/url]
* [url=https://underr.space/notes/projects/project-008.html]Homepage[/url]

[b]License[/b]
[url=https://raw.githubusercontent.com/underr-ua/ocmod3-breadcrumbs-plus/master/EULA.txt]End-User License Agreement[/url]
